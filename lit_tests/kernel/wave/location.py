...
def test_location_local_scope():
    ...
    # CHECK: vector.load {{.*}} loc("{{.*}}location.py":43
    # CHECK: arith.addf {{.*}} loc("{{.*}}location.py":44
    #
    # CHECK: @isolated_benchmark(%{{.*}} loc("a"("{{.*}}location.py":46{{.*}} loc("b"("{{.*}}location.py":46
...
def test_location_global_scope():
    ...
    # CHECK-DAG: #[[loc_arg:.+]] = loc("{{.*}}location.py":64
    ...
    # CHECK-DAG: #[[loc_load]] = loc("{{.*}}location.py":61
    # CHECK-DAG: #[[loc_addf]] = loc("{{.*}}location.py":62
