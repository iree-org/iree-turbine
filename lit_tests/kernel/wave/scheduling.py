...
def test_gemm_pipelined():
    ...
    with tk.gen.TestLaunchContext(
        ...
        # CHECK-NEXT: %read_4_shared_M_0_N_0_K_0
        # TODO: Why did this change from K_1 to K_0???
        # CHECK-NEXT: %read_2_shared_M_0_N_0_K_0
        # CHECK-NEXT: %read_21
        # CHECK-NEXT: %read_22
        # CHECK-NEXT: %scheduling_group_barrier
        # CHECK-SAME: ({Operation.READ_SHARED: 2, Operation.READ_GLOBAL: 2}, 0)
        # CHECK-NEXT: %read_4_shared_M_0_N_1_K_0
        # CHECK-NEXT: %read_4_shared_M_0_N_1_K_1
        # CHECK-NEXT: %mma_M_0_N_0_K_0
        # CHECK-SAME: (%read_2_shared_M_0_N_0_K_0, %read_4_shared_M_0_N_0_K_0, %acc_m_0_n_0_k_0, None)
        # CHECK-NEXT: %mma_M_1_N_0_K_0
        # CHECK-SAME: (%rotating_reg_2, %read_4_shared_M_0_N_0_K_0, %acc_m_1_n_0_k_0, None)
        ...
        # CHECK-SAME: (%read_2_shared_M_0_N_0_K_0, %read_4_shared_M_0_N_1_K_0, %acc_m_0_n_1_k_0, None)
        # CHECK-NEXT: %mma_M_1_N_1_K_0
        # CHECK-SAME: (%rotating_reg_2, %read_4_shared_M_0_N_1_K_0, %acc_m_1_n_1_k_0, None)
        # CHECK-NEXT: %read_2_shared_M_1_N_0_K_0
        # CHECK-NEXT: %read_2_shared_M_1_N_0_K_1
        # CHECK-NEXT: %scheduling_group_barrier_3
        # CHECK-SAME: ({Operation.MMA: 2, Operation.READ_SHARED: 2}, 0)
        # CHECK-NEXT: %mma_M_0_N_1_K_1
        # CHECK-SAME: (%rotating_reg_1, %read_4_shared_M_0_N_1_K_1, %mma_M_0_N_1_K_0, None)
        # CHECK-NEXT: %mma_M_1_N_1_K_1
        # CHECK-SAME: (%rotating_reg_3, %read_4_shared_M_0_N_1_K_1, %mma_M_1_N_1_K_0, None)
        # CHECK-NEXT: %read_4_shared_M_0_N_0_K_1
        # CHECK-NEXT: %read_2_shared_M_0_N_0_K_1
        # CHECK-NEXT: %scheduling_group_barrier_4
        # CHECK-SAME: ({Operation.MMA: 2, Operation.READ_SHARED: 2}, 0)
        # CHECK-NEXT: [mma_M_0_N_0_K_1, mma_M_0_N_1_K_1, mma_M_1_N_0_K_1, mma_M_1_N_1_K_1, read_4_shared_M_0_N_0_K_1, read_2_shared_M_0_N_0_K_1, read_2_shared_M_1_N_0_K_0, read_2_shared_M_1_N_0_K_1]
        ...
        # CHECK-NEXT: %mma_M_0_N_0_K_0
        # CHECK-SAME: (%read_2_shared_M_0_N_0_K_0, %read_4_shared_M_0_N_0_K_0, %get_result_M:0_N:0_K:0, None)
        # CHECK-NEXT: %mma_M_1_N_0_K_0
        # CHECK-SAME: (%get_result_11, %read_4_shared_M_0_N_0_K_0, %get_result_M:1_N:0_K:0, None)
        # CHECK-NEXT: %mma_M_0_N_0_K_1
        # CHECK-SAME: (%get_result_10, %get_result_9, %mma_M_0_N_0_K_0, None)
        # CHECK-NEXT: %mma_M_1_N_0_K_1
        # CHECK-SAME: (%get_result_12, %get_result_9, %mma_M_1_N_0_K_0, None)
        # CHECK-NEXT: %mma_M_0_N_1_K_0
        # CHECK-SAME: (%read_2_shared_M_0_N_0_K_0, %read_4_shared_M_0_N_1_K_0, %get_result_M:0_N:1_K:0, None)
        # CHECK-NEXT: %mma_M_1_N_1_K_0
        # CHECK-SAME: (%get_result_11, %read_4_shared_M_0_N_1_K_0, %get_result_M:1_N:1_K:0, None)
        # CHECK-NEXT: %mma_M_0_N_1_K_1
        # CHECK-SAME: (%get_result_10, %read_4_shared_M_0_N_1_K_1, %mma_M_0_N_1_K_0, None)
        # CHECK-NEXT: %mma_M_1_N_1_K_1
        # CHECK-SAME: (%get_result_12, %read_4_shared_M_0_N_1_K_1, %mma_M_1_N_1_K_0, None)
