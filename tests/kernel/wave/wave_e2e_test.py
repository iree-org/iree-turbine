...
_igemm_cases += [
    ...
    _skip_case(2, 128, 128, 320, 1, 1, 640, 1),
    _skip_case(2, 128, 128, 320, 1, 1, 960, 1),
    (2, 128, 128, 320, 3, 3, 16, 1),
    _skip_case(2, 128, 128, 320, 3, 3, 320, 1),
    _skip_case(2, 32, 32, 1280, 1, 1, 1920, 1),
    _skip_case(2, 32, 32, 1280, 1, 1, 2560, 1),
    (2, 32, 32, 1280, 1, 1, 640, 1),
    _skip_case(2, 32, 32, 1280, 3, 3, 1280, 1),
    _skip_case(2, 32, 32, 1280, 3, 3, 1920, 1),
    _skip_case(2, 32, 32, 1280, 3, 3, 2560, 1),
    (2, 32, 32, 1280, 3, 3, 640, 1),
    _skip_case(2, 32, 32, 640, 3, 3, 640, 1),
    _skip_case(2, 64, 64, 320, 3, 3, 320, 1),
    _skip_case(2, 64, 64, 640, 1, 1, 1280, 1),
    _skip_case(2, 64, 64, 640, 1, 1, 1920, 1),
    (2, 64, 64, 640, 1, 1, 320, 1),
    _skip_case(2, 64, 64, 640, 1, 1, 960, 1),
    _skip_case(2, 64, 64, 640, 3, 3, 320, 1),
