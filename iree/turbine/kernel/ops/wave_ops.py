...
class Read(CustomOp):
    ...
    This is a rank-reducing operation, where the output is a 3D tensor and the input is a 4D tensor.
    ...
    def indexing_dims(self) -> list[IndexSymbol]:
        ...
        return [x for x in self.memory_type.symbolic_shape if x not in self.drop_dims]
