...
int launch(const KernelLaunchInfo &info, const Int64Vector &tensors, const Int32Vector &dynamicDims)
{
    ...
    HIP_CHECK_RETURN(hipModuleLaunchKernel(function, info.gridX, info.gridY, info.gridZ, info.blockX, info.blockY, info.blockZ, info.sharedMemoryBytes, stream, nullptr, (void **)&hipLaunchParams));
    return hipSuccess;
}
